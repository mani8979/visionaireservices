    ...
    <div className="bg-secondary text-primary">
      ...
      <section className="relative h-[70vh] md:h-[85vh] w-full flex items-center justify-center overflow-hidden">
        <div className="w-full h-auto relative flex">
          <Image src={data?.heroImageUrl || "/images/putty_painting.png"} alt="Putty Painting Hero" width={0} height={0} sizes="100vw" style={{ width: '100%', height: 'auto' }} className="w-full h-auto object-contain object-center"
            priority
          />
      ...
      <section className="py-32 px-6 lg:px-12 bg-primary text-secondary">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          ...
          >
            <Image src={data?.beforeImageUrl || "/images/constructions_hero.png"} alt="Surface Preparation" width={0} height={0} sizes="100vw" style={{ width: '100%', height: 'auto' }} className="w-full h-auto object-contain transition-transform duration-[2s] group-hover:scale-105" />
          ...
          <motion.div 
            ...
            className="relative aspect-[3/4] md:aspect-[4/5] group overflow-hidden rounded-sm shadow-xl"
          >
            <Image src={data?.afterImageUrl || "/images/putty_painting.png"} alt="Flawless Finish" width={0} height={0} sizes="100vw" style={{ width: '100%', height: 'auto' }} className="w-full h-auto object-contain transition-transform duration-[2s] group-hover:scale-105" />
