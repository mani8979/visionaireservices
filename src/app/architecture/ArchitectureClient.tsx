      ...
      <section className="py-32 px-6 lg:px-12 bg-primary text-secondary">
        <div className="max-w-7xl mx-auto space-y-32 lg:space-y-48">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            ...
            >
              <Image src={data?.residentialImageUrl || "/images/residential_const.png"} alt="Residential Architecture" width={0} height={0} sizes="100vw" style={{ width: '100%', height: 'auto' }} className="w-full h-auto object-contain rounded-sm shadow-2xl" unoptimized={true} />
            </motion.div>
            <motion.div 
              initial={{ opacity: 0, x: 30 }}
              whileInView={{ opacity: 1, x: 0 }}
          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16 lg:gap-24">
            <motion.div 
              ...
              className="lg:w-1/2 w-full h-fit relative rounded-sm overflow-hidden"
            >
              <Image src={data?.commercialImageUrl || "/images/hero_architecture.png"} alt="Commercial Architecture" width={0} height={0} sizes="100vw" style={{ width: '100%', height: 'auto' }} className="w-full h-auto object-contain rounded-sm shadow-2xl" unoptimized={true} />
            </motion.div>
            <motion.div 
              initial={{ opacity: 0, x: -30 }}
              whileInView={{ opacity: 1, x: 0 }}
      ...
      <section className="py-32 px-6 lg:px-12 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 1 }} className="relative w-full h-fit group overflow-hidden rounded-sm shadow-lg">
             <Image src={data?.beforeImageUrl || "/images/constructions_hero.png"} alt="Blueprint" width={0} height={0} sizes="100vw" style={{ width: '100%', height: 'auto' }} className="w-full h-auto object-contain transition-transform duration-[2s] group-hover:scale-105" unoptimized={true} />
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 1, delay: 0.2 }} className="relative w-full h-fit group overflow-hidden rounded-sm shadow-lg">
             <Image src={data?.afterImageUrl || "/images/hero_architecture.png"} alt="Finished Structure" width={0} height={0} sizes="100vw" style={{ width: '100%', height: 'auto' }} className="w-full h-auto object-contain transition-transform duration-[2s] group-hover:scale-105" unoptimized={true} />
             <div className="absolute top-6 left-6 bg-accent/90 text-secondary px-6 py-3 text-xs font-semibold tracking-[0.2em] uppercase backdrop-blur-sm">Final Structure</div>
          </motion.div>
        </div>
      </section>
    </div>
