    ...
    <div className="bg-secondary text-primary">
      ...
      <section className="relative h-[70vh] md:h-[85vh] w-full flex items-center justify-center overflow-hidden">
        <div className="w-full h-auto relative flex">
          <Image src={data?.heroImageUrl || "/images/finishing_hero.png"} alt="False Ceiling Hero" width={0} height={0} sizes="100vw" style={{ width: '100%', height: 'auto' }} className="w-full h-auto object-contain object-center"
            priority
          />
